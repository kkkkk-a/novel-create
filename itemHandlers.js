...
export function initItemHandlers() {
    ...
    const inputs = [
        ...
        'item-max-stack',
        'item-effect-hp', 'item-effect-hp-max', 'item-effect-stamina', 'item-effect-stamina-max', 'item-effect-ammo', 
        'item-effect-atk', 'item-effect-def','item-effect-spd', 'item-effect-proj-speed',
